        ...
        <Table>
            ...
            <TBody>
                {students.map((student) => (<TRow key={student.id}>
                    ...
                    <TCell>{student.activated ? <Button disabled={disable} className={"bg-transparent h-10 w-10 p-0 hover:bg-transparent"}
                                                        onClick={() => handleActivateStatusStudent(student.id, false)}><X
                            className={"h-4 w-4 text-red-500 hover:text-red-700"}/></Button> :
                        <Button disabled={disable} className={"bg-transparent h-10 w-10 p-0 hover:bg-transparent"}
